                    ...
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs">
                            ...
                            <li class="nav-item">
                                ...
                                href="#traitement">Traitement</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" role="tab" data-toggle="tab" 
                                href="#paiement">Paiement</a>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="acquisition">
                            <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <select id="" class="form-control">
                                                ...
                                                <option value="">Lieu d'habitation / Professionnel</option>
                                                <option value="">Plantation</option>
                                            </select>
                                    ...
                                    <label class="form-check-label" for="gridCheck">
                                        ...
                                        <div class="form-group col-md-12">
                                            <a href="#" target="_blank"><button type="submit"
                                                    class="btn btn-primary">Valider</button></a>
                                        </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="#traitement">
                            <p>Payer par virement banquaire</p>
                            <p><strong>CI032 01016 008291260001 51</strong></p>
                            <p><strong>INTERNATIONAL REAL ESTATE</strong></p>
                            <p>
                                <strong>AGENCY IREA</strong>
                                <strong>RIV PALMERAIE FACE ST VIATEUR 2</strong>
                            </p>
                        </div>
                        <div role="tabpanel" class="tab-pane" id="#paiement">3</div>
                    </div>
                </div>
            </div>
        </div>
